...
def display_tmi(df):
    ...
    # --- Row 1: Metrik Utama (Menggunakan 'Tahun') ---
    ...
    # --- Row 3: Analisis Tren Penyakit Per Bulan (Menggunakan 'Tahun_Bulan') ---
    # Perubahan di sini untuk memastikan index yang digunakan adalah 'Tahun_Bulan'
    if 'Tahun_Bulan' in df.columns and (df['Tahun_Bulan'] != 'N/A').any():
        ...
        # 3. Pivot data: KRUSIAL - Menggunakan 'Tahun_Bulan' sebagai index
